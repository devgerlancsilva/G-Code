...
- **Histórico de Senhas:** Uma barra lateral que rastreia os últimos códigos gerados na sessão, permitindo recuperá-los facilmente.
- **Dicas de Segurança:** O sistema apresenta alertas e dicas variadas sobre como manter uma boa higiene digital.
...
2. **Instale as dependências** do projeto usando o terminal:
   ```bash
   npm install
   ```
...
4. **Inicie o servidor de desenvolvimento:**
   ...
   npm run dev
   ```
5. Abra no navegador o endereço fornecido (geralmente `http://localhost:3000` ou `http://localhost:3001`).

---
<div align="center">
  <b>Desenvolvido por Gêrlan Cardoso</b>
</div>
